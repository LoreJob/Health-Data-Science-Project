...
ggplot(smokers_df, aes(x = ADNSMK42)) +
  ...
  labs(title = "Distribution of Smokers by Doctor's Recommendation", x = "Doctor's Recommendation", y = "Frequency")
```
...
ggplot(smokers_df, aes(x = SDENICPROD == "1 YES")) +
  ...
  labs(title = "Distribution of e-Smokers through currently smokers", x = "E-smokers No/Yes", y = "Frequency")
```
...
cont_tables(small_df,"ADSMOK42","DIABDX_M18")
